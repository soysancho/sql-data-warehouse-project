...
BEGIN
  -- Parameters @start_time, @end_time, @batch_start_time, @batch_end_time are necessary to capture how much time the batch process takes.
	...
	BEGIN TRY
		...
		FROM 'C:\Users\User\Desktop\sql-data-warehouse-project\datasets\prd_info.csv'
		WITH (
			FIRSTROW = 2,
			FIELDTERMINATOR = ',',
			TABLOCK
